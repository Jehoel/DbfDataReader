...
namespace Dbf.Tests
{
    ...
    public class DbfDataReaderTests : DbaseTests, IDisposable
    {
        ...
        public void Should_compute_subset_runs_correctly()
        {
            ...
            {
                new DbfColumn( 0, "ColA", DbfColumnType.Number   ,  7, 0, DbfActualColumnType.NumberText ),
                new DbfColumn( 1, "ColB", DbfColumnType.Character, 10, 0, DbfActualColumnType.Text ),
                new DbfColumn( 2, "ColC", DbfColumnType.Logical  ,  1, 0, DbfActualColumnType.BooleanText ),
                new DbfColumn( 3, "ColD", DbfColumnType.DateTime ,  8, 0, DbfActualColumnType.DateTimeBinaryJulian ),
                new DbfColumn( 4, "ColE", DbfColumnType.Number   ,  7, 0, DbfActualColumnType.NumberText ),
                new DbfColumn( 5, "ColF", DbfColumnType.Character, 10, 0, DbfActualColumnType.Text ),
                new DbfColumn( 6, "ColG", DbfColumnType.Logical  ,  1, 0, DbfActualColumnType.BooleanText ),
                new DbfColumn( 7, "ColH", DbfColumnType.DateTime ,  8, 0, DbfActualColumnType.DateTimeBinaryJulian )
            };
